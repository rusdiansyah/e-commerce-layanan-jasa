<div>
    <x-card-filter judul="{{ $title }}" warna="success">
        <div class="row">
            <div class="col-md-6">
                <x-live-select name="filterRole" label="Role">
                ...
                <tr>
                    <th>
                        <div class="custom-control custom-checkbox">
                            <input class="custom-control custom-checkbox-input" type="checkbox" wire:model="selectAll"
